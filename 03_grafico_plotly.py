...
df_consolidado = pd.DataFrame({'Status': ['Ativo','Inativo','Ativo','Inativo','Ativo','Inativo','cancelado', 'cancelado', 'Ativo']})
...
def grafico_pizza():
    ...
    fig = px.pie(status_dist, values='Quantidade', names = 'Status', title = 'Distribuição do Status')
    # converter para html
